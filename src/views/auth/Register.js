    ...
    <Container>
      <Grid container justify="space-evenly" alignItems="center">
        <Grid item lg={12} sm={10}>
          ...
          <Paper style={{ borderRadius: "2rem" }} elevation={12} mb="10rem" component={Box} p={4}>
                    ...
                    onBlur={(e) => {
                      ...
                      if (em == "") {
                        ...
                        axios.get(`http://localhost:8000/user/${em}`)
                          ...
                          .catch(err => { setUser_msg("Email is alreday register") }
                          )
                      }
                    }}
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item lg={6} sm={12} xs={12}>
                      <FormControl margin="normal" fullWidth error={Boolean(errors.states)}>
                        <Controller
                          render={(props) => (
                            <Select displayEmpty variant="filled" value={props.value} className={classes.color} onChange={props.onChange}
                              startAdornment={
                                <InputAdornment position="start">
                              ...
                              onBlur={(e) => {
                                ...
                                async function fechCity() {
                                  const city = await axios.get(`http://localhost:8000/city/${state}`);
              ...
              <Grid item lg={5} sm={10}>
                <Box textAlign="center" pt={6} pd={6} maxWidth="100%" maxHeight="100%">
                  ...
                  <Typography component={Box} pt={4}>
                    <a style={{ color: 'grey', textDecoration: "none", fontSize: "13px" }} href="/login">
                      I am already  member
                                            </a>
                  </Typography>
                </Box>
