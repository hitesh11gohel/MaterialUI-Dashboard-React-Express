...
//image import
import Img from './../../assets/images/reimg.jpg';
                                            ...
                                            <FormControl margin="normal" fullWidth error={Boolean(errors.states)}>
                                                <Controller
                                                    render={(props) => (
                                                        ...
                                                        {STate.map(post => (
                                                            <MenuItem key={post.stateid} value={post.stateid}>{post.lable}</MenuItem>
                                                        ))}
                                                        </Select>
                                                    )}
                                                    rules={{
                                            ...
                                            <Controller
                                                    render={(props) => (
                                                        ...
                                                        <MenuItem value="">City</MenuItem>
                                                            {city.map(post => (
                                                                <MenuItem key={post.cityid} value={post.cityid}>{post.lable}</MenuItem>
                                                            ))}
                                                              </Select>
                                                    )}
                                                    rules={{
